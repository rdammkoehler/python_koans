...
class AboutAttributeAccess(Koan):
    ...
    def test_calling_undefined_functions_normally_results_in_errors(self):
        ...
        try:
            ...
            self.assertMatch("no attribute", exception[0])
    ...
    def test_intercepting_return_values_can_disrupt_the_call_chain(self):
        ...
        self.assertMatch("Someone called 'foobaz'", catcher.foobaz)  # This is fine

        try:
            catcher.foobaz(1)
        except TypeError as ex:
            self.assertMatch("not callable", ex[0])
    ...
    def test_changing_getattribute_will_affect__the_getattr_function(self):
        ...
        self.assertMatch("Someone called 'any_attribute'", getattr(catcher, 'any_attribute'))
